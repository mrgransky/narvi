...
#SBATCH -o /home/alijani/Datasets/kitti_color/DeepVO_misc/logs/gpu_test_%j_a.txt
#SBATCH -e /home/alijani/Datasets/kitti_color/DeepVO_misc/logs/gpu_test_%j_a.txt
